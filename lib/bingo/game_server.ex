defmodule Bingo.GameServer do
  @moduledoc """
  A game server process that holds Game struct as its state
  """
  use GenServer
  ...
  @doc """
  Returns the pid of the game server process registered under the giver game_name or nil if no process is registered
  """
