defmodule Bingo.BingoChecker do
  ...
  Returns `true` if all the squares of
  ...
  @doc """
  Returns a 2D list of all possible winning square sequences: rows, columns, left diagonal, and right diagonal.
  """
  ...
  @doc """
  Returns a list of those sequences that have at least one square marked.
  """
  ...
  @doc """
  Returns `true` if the sequence has all squares marked by the same player.
